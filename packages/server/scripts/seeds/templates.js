...
const seedTemplates = async () => {
  ...
  try {
    ...
    if (!fs.existsSync(templatesFolder)) {
      logger.warn('templates folder is not available; skipping template seeding for this startup')
      return
    }
    ...
    if (!fetchedTemplates.length) {
      logger.warn('no templates were fetched; skipping template seeding for this startup')
      return
    }
