...
const getBookCollectionHandler = async (_, { input }) => {
  try {
    const { id } = input
...
const getBookCollectionsHandler = async () => {
  try {
    logger.info(
...
const createBookCollectionHandler = async (_, { input }) => {
  try {
...
module.exports = {
  ...
  BookCollection: {
    ...
    async books(bookCollection, { ascending, sortKey, archived }, ctx) {
