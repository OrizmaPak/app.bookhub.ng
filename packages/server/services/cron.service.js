const { useTransaction, logger, tempFolderPath } = require('@coko/server')
...
const getTempDir = serviceSubfolder => {
  return `${tempFolderPath}/${serviceSubfolder}`
}
...
const tempDirectoryCleanup = async () => {
  try {
...
module.exports = { cleanUpIdleLocks, tempDirectoryCleanup }
